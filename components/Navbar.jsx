    ...
    return (
        <div className='fixed w-full h-20 shadow-xl z-[100]'>
            <div className='flex justify-between items-center w-full h-full px-2 2xl:px-10'>
                <Image src="/../public/assets/cat.png" width='50' height='50' alt="/"/>
                <div>
                ...
                >
                    <div>
                        <div className='flex w-full items-center justify-between'>
                            <Image src="/../public/assets/cat.png" width='40' height='40' alt="/"/>
                    ...
                    <div className='py-4 flex flex-col'>
                        ...
                        <div className='pt-40'>
                            <p className='uppercase tracking-widest text-[#429E9D]'>
                                Let's Connect
                            </p>
